...
export default function Home() {
 ...
 const handleSolve = async () => {
   ...
   try {
     ...
     if (selectedImage) {
       payload.text = inputValue || "Solve this math problem step by step and format the solution with LaTeX math expressions enclosed in $$ for display math and $ for inline math. Show all steps clearly."
